...
Mỗi tầng dữ liệu có thể được lưu vào các Iceberg table riêng biệt. Các Iceberg table này sử dụng MinIO làm storage backend để lưu file dữ liệu, metadata và snapshot, giúp hệ thống dễ quản lý version, schema, lineage và khả năng tái xử lý.
